...
from src.tools.colors import bcolors, unicode_signs
...
class FileDownloader:
    ...
    def _download(self, data) -> None:
        ...
        # maybe use design pattern to get this green tick in these strings
        print(f"{bcolors.OKGREEN}{unicode_signs.GREEN_TICK}{bcolors.ENDC} '{filename}' Downloaded successfully")
